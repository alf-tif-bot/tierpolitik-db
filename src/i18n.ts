...
const contentDictionary: Record<Language, Array<[RegExp, string]>> = {
  ...
  fr: [
    ...
    [/Biodiversität|Biodiversitaet/gi, 'biodiversité'],
  ...
  it: [
    ...
    [/Ernährung|Ernaehrung/gi, 'alimentazione'],
    [/Biodiversität|Biodiversitaet/gi, 'biodiversità'],
  ...
  en: [
    ...
    [/Ernährung|Ernaehrung/gi, 'nutrition'],
    [/Biodiversität|Biodiversitaet/gi, 'biodiversity'],
