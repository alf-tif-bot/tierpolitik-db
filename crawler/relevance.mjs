...
export const ANCHOR_KEYWORDS = [
  ...
  'haustier', 'haustiere', 'heimtier', 'heimtiere', 'hunde', 'hund', 'katze', 'katzen', 'kaninchen', 'pferd', 'pferde', 'esel', 'maultier', 'maulesel', 'schaf', 'schafe', 'ziege', 'ziegen', 'rind', 'rinder', 'kuh', 'kühe', 'kuehe', 'kalb', 'kälber', 'kaelber', 'hühner', 'huehner', 'geflügel', 'gefluegel', 'ente', 'enten', 'gans', 'gänse', 'gaense', 'vogelgrippe', 'schwein', 'schweine', 'schweinemast', 'schweinezucht', 'fisch', 'fische',
  'wildtier', 'wildtiere', 'wolf', 'biber', 'fuchs',
  'biodiversität', 'biodiversitaet', 'biodiversite', 'biodiversita',
  'zoo', 'zoos', 'tierpark', 'wildpark', 'zirkus', 'circus',
  'tierqual', 'tierquälerei', 'tierquaelerei', 'quälerei', 'quaelerei', 'maltraitance',
...
const SUPPORT_KEYWORDS = [
  ...
  'schlacht', 'mast', 'pelz', 'fisch', 'jagd', 'wildtier', 'tierquälerei', 'tierquaelerei', 'tierversuch', 'zirkus', 'zoo', 'tierpark', 'bien-être', 'bien etre',
  'animalier', 'animale', 'animali', 'faune', 'allevamenti', 'verband', 'verbände', 'verbaende', 'verein', 'organisation',
