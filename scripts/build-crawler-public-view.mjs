...
<body>
  <main class="wrap">
    ...
    <p><small>Hinweis: <code>/.netlify/functions/*</code> funktioniert nur, wenn Netlify Functions aktiv sind oder auf dem Host entsprechend gemappt werden.</small></p>
  </main>
<script>
const checks=[
  {path:'/home-data',method:'GET'},
  {path:'/feedback-submit',method:'POST',body:{id:'debug',vote:'up'}},
  {path:'/review-decision',method:'POST',body:{id:'debug',status:'approved'}},
  {path:'/review-fastlane-tag',method:'POST',body:{id:'debug',fastlane:true}},
  {path:'/.netlify/functions/home-data',method:'GET'},
  {path:'/.netlify/functions/feedback-submit',method:'POST',body:{id:'debug',vote:'up'}},
  {path:'/.netlify/functions/review-decision',method:'POST',body:{id:'debug',status:'approved'}},
  {path:'/.netlify/functions/review-fastlane-tag',method:'POST',body:{id:'debug',fastlane:true}},
]
